...
<!-- this is like an if/else type of statement to print an error if the user does not have "admin" priviledges -->
<c:choose>
<c:when test= "${utype == 'admin'}">
...
<c:otherwise>
		<div>You must be an administrator to add a forum.</div>
		<br />
        <div><a href="DisplayForums">Back To Forums</a></div>
        <br />
    </c:otherwise>
</c:choose>
</div>
